...
class Library:
    ...
    def new_book(self, name, year, author):
        ...
        self.books.append(b)
        return b
    #regarding last question. Book should be added to the Author. 
    # I think we already have in line 6
    ...
    def new_author(self, name, country, birthday):
        a = Author(name, country, birthday)
